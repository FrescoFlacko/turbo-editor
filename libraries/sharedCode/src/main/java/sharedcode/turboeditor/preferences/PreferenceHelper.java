...
public final class PreferenceHelper {
    ...
    public static boolean getIndigoTheme(Context context) {
        return getPrefs(context).getInt("theme", 0) == 3;
    }

    public static boolean getLightGreenTheme(Context context) {
        return getPrefs(context).getInt("theme", 0) == 4;
    }

    public static boolean getGreyTheme(Context context) {
        return getPrefs(context).getInt("theme", 0) == 5;
    }
