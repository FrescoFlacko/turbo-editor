...
public class AccessoryView extends LinearLayout {
    ...
    private void addAButton(final String text) {
        ...
        name.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               iAccessoryView.onButtonAccessoryViewClicked(text.equals("TAB") ? "\t" : text);
            }
        });
    ...
    public void updateTextColors() {
        boolean isLightTheme = PreferenceHelper.getLightTheme(getContext()) || PreferenceHelper.getLightGreenTheme(getContext()) || PreferenceHelper.getGreyTheme(getContext());
